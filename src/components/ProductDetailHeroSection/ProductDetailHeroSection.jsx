        ...
        <section className="w-full flex flex-col items-center  mb-12">
            <div className="flex flex-col md:flex-row gap-10 p-6">
                ...
                <div className="w-full md:w-1/2 text-left">
                    <h1 className="text-4xl font-santa">{product.name}</h1>
                                ...
                                {product.customizations.map((option) => (
                                    <label key={option.id} className="flex items-center gap-3 cursor-pointer group">
                                        <div
                                            ...
                                            className={`w-6 h-6 rounded border-2 flex items-center justify-center transition-colors ${selectedOptions[option.id] ? "bg-[#DEA401] border-[#DEA401]" : "bg-white border-gray-300"
                                                }`}
                                        >
                                            {selectedOptions[option.id] && <span className="text-white text-xs">✓</span>}
                                        </div>
